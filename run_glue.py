...
from custom_model import CustomRobertaForSequenceClassification, CustomGPT2ForSequenceClassification
from save_on_end_epoch import SaveOnEndEpochTrainerCallback

MODEL_NAME_TO_CLASS = {
    "roberta_custom": CustomRobertaForSequenceClassification,
